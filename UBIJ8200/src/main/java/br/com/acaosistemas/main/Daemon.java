...
public class Daemon {
	...
	public static void main(String[] args) {
		...
		if (args.length != 3) {
			...
			logger.info("Quantidade de parametros insuficientes.");
			logger.info("Utilize o comando abaixo para executar a aplicacao, utilizando o Java 1.8 ou superior:");
			logger.info("java -jar UBIJ8200.jar usuarioDB senhaDB servidorDB:portaListner:instanciaDB");
			System.exit(1);
		}
    ...
    private void lerPipeDB() {
		...
		logger.info("Processando registros dos correios...");
